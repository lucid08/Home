    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          ...
          <Link href="/home-listings/add" passHref>
            <button
              type="button"
              className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center gap-2 shadow-lg"
            >
          ...
          {homes.map((home) => (
            ...
            >
              <div className="relative h-48 bg-gray-200">
                ...
                <img src="/placeholder.png" alt="Property preview" className="object-cover w-full h-full" />
              ...
              <div className="p-6">
                ...
                <Link href={`/home-listings/${home.id}`} passHref>
                  <button
                    type="button"
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 px-4 rounded-lg transition-all duration-300 transform hover:scale-[1.02] flex items-center justify-center gap-2"
                  >
